...
Current sprint status can be found in the "Iteration status page". The iteration status page contains the user stories
the team is currently working on, as well effort estimation for each user story, in points for user stories, and hours
needed to complete for sub-tasks for each user story.
The product backlog can be found in the "Backlog" page. This page contains all backlog items(user stories and defects) prioritized by list order. 
